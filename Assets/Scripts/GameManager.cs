...
public class GameManager : MonoBehaviour
{
    ...
    public Water dirty; // get from river
    public Water clean; // get from converting dirty water
    public Water pure; // generated by upgrades. ignore storage
    ...
    void Update()
    {
        ...
        if (timer > 1){
            ...
            dirty.storage = CleanFloat(dirty.storage-clean.autoMod);
            clean.storage = CleanFloat(clean.storage+clean.autoMod);
            clean.storage = CleanFloat(clean.storage+pure.autoMod);
            timer = 0f;
    ...
    public void CleanClick(){
        clean.storage = CleanFloat(clean.storage+pure.clickMod);
